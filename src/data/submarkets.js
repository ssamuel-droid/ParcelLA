...
export const RENTS = {
  ...
  // Median active apartment listings within 3 miles of 11070 Borden, RentCast 2026-09-24.
  'Pacoima':       { studio: 1650, one: 1973, two: 2385, three: 3007 },
...
export const CAP_RATES = {
  'Venice':        0.0425,
  'Pacific Palisades': 0.0400,
  'Brentwood':     0.0425,
  'Playa Vista':   0.0425,
  'Silver Lake':   0.0475,
  'Los Feliz':     0.0475,
  'Hollywood Hills': 0.0475,
  'Culver City':   0.0450,
  'West LA':       0.0450,
  'Mar Vista':     0.0475,
  'Studio City':   0.0475,
  'Hancock Park':  0.0475,
  'Echo Park':     0.0500,
  'Atwater Village': 0.0500,
  'Mid-Wilshire':  0.0500,
  'Hollywood':     0.0500,
  'Sherman Oaks':  0.0500,
  'Encino':        0.0500,
  'East Hollywood': 0.0525,
  'Highland Park': 0.0525,
  'Eagle Rock':    0.0500,
  'Glassell Park': 0.0525,
  'Mount Washington': 0.0525,
  'Koreatown':     0.0525,
  'West Adams':    0.0525,
  'Lincoln Heights': 0.0550,
  'North Hollywood': 0.0525,
  'Woodland Hills': 0.0525,
  'Granada Hills': 0.0525,
  'Northridge':    0.0550,
  'Leimert Park':  0.0550,
  'El Sereno':     0.0575,
...
export const MAP_COORDS = {
  ...
  'Hollywood Hills': { lat: 34.1070, lng: -118.3710 },
  ...
  'Chatsworth':    { lat: 34.2506, lng: -118.6148 },
};
