...
CREATE TABLE sites (
  ...
  zoning          TEXT,
  lot_sf          INTEGER,
  project_type    TEXT CHECK (project_type IN ('Multifamily','Mixed-Use','Condo/TH','New House')),
  units           INTEGER,
  avg_unit_sf     INTEGER,
  price           BIGINT,
  ...
  owner_name      TEXT,
  owner_last_sale_date DATE,
  owner_last_sale_amount BIGINT,
  owner_source    TEXT,
...
INSERT INTO sites (address, neighborhood, zip, zoning, lot_sf, project_type, units, avg_unit_sf, price, rti, has_demo, unit_mix, data_source, is_comp) VALUES
  ...
  ('5634 Monte Vista St','Highland Park','90042','R2',5400,'New House',1,2400,880000,false,true,'{"studio":0,"one":0,"two":0,"three":1}','seed',false),
  ...
  ('2100 W Silver Lake Dr','Silver Lake','90039','R2',8200,'New House',1,2800,1100000,false,true,'{"studio":0,"one":0,"two":0,"three":1}','seed',false),
  ...
  ('915 N Ave 52','Highland Park','90042','R2',5000,'New House',1,2300,750000,true,false,'{"studio":0,"one":0,"two":0,"three":1}','seed',false),
